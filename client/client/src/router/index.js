...
import SignUp from '@/components/AILabs/SignUp.vue'
import SignIn from '@/components/AILabs/SignIn.vue'
...
export const constantRouterMap = [
  // { path: '/', redirect: '/databases/index' },
  // { path: '/signUp', component: SignUp, hidden: false },
  // { path: '/signIn', component: SignIn, hidden: false },
...
export const asyncRouterMap = [
...

  {
    ...
    children: [
      {
        path: 'index', 
        component: _import('databases/index'),
        name: 'databases',
        meta: {
          title: 'databases',
          icon: 'table'
  ...
  //   children: [
  //     {
  //       path: 'list', component: _import('databases/list/index'), name: 'list',
  //       // redirect: '/databases/list',
  //       meta: {
  //         title: 'list', // 顯示在 sideNav 的名稱, 並會自產生路徑
  //         icon: 'table',
  //         noCache: true,
  //       }
  //     },
  //     {
  //       path: 'upload', component: _import('databases/upload/index'), name: 'upload',
  //       // redirect: '/databases/upload',
  //       meta: {
  //         title: 'upload', // 顯示在 sideNav 的名稱, 並會自產生路徑
  //         icon: 'table',
  //         noCache: true,
  //       }
  //     },
